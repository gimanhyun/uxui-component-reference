...
export const OUTFIT_SAMPLES: OutfitSample[] = [
  {
    id: 'feminine-bustier',
    styleName: '아이보리 플라워 롱 뷔스티에 원피스 룩',
    styleDescription: '릴스 히트 아이보리 롱 레이스 뷔스티에 & 슬릿 레이어드 원피스 룩',
        ...
        matchedItems: [
          {
            id: 'top-bustier-1',
            brand: '29CM (Sinoon)',
            title: '로맨틱 아이보리 펀칭 레이스 롱 뷔스티에 원피스 (캡처 착장 동일 PDP)',
          ...
          },
          {
            id: 'top-bustier-3',
            brand: '무신사 (Slowand)',
            title: '시스루 펀칭 레이스 레이어드 롱 뷔스티에 나시원피스',
            originalPrice: 89000,
            discountPrice: 71200,
            discountRate: 20,
        ...
        matchedItems: [
          {
            id: 'bot-bustier-1',
            brand: '29CM (BLACKUP)',
            title: '어시메트릭 언발 레이스 레이어드 롱 스커트 데님 세트 (PDP 상세)',
            originalPrice: 64000,
            discountPrice: 51200,
            discountRate: 20,
        ...
        matchedItems: [
          {
            id: 'sh-bustier-1',
            brand: '29CM (마르지엘라)',
            title: '레더 레이스업 메리제인 스니커즈 [화이트 크림] (PDP 상세)',
